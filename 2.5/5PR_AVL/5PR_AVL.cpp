...
int main() {
	...
	while (true)
	{
		...
		cout << "3. Поиск узла в AVL-дереве по ключу и вывод из двоичного файла" << endl;
		cout << "4. Добавление узла в AVL-дерево и двоичный файл по ключу" << endl;
		cout << "5. Удаление записи из AVL-дерева и двоичного файла" << endl;
		...
		case 2: {
			...
			if (fin.is_open()) {
				...
				if (fin.bad()) {
					cout << "Ошибка создания AVL-дерева из данных двоичного файла." << endl;
					return 1;
				}
